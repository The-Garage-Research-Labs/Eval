...
# EXPERIMENT_NAME = "pruner_finetuned_model"
...
#         # temperature=0.5,
#         lora_modules={
#             "pruner": "abdo-Mansour/Pruner_Adaptor_Qwen3_0.6b",
#             # "extractor": "abdo-Mansour/Extractor_Adaptor_Qwen3_0.6b"
#         },
# ) 

reranker_extractor_config = RerankerExtractorConfig(
    same_llm_config= False,
